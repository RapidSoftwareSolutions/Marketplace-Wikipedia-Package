...
$app->post('/api/Wikipedia/getPageByRevisionId', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['revIds']);
    ...
    $bodyParams = [
       'query' => ['rawcontinue','iwurl','indexpageids','export','list','revids','prop']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);


    if(!empty($data['revids']))
    {
        $data['revids'] = \Models\Params::toString($data['revids'], '|');
    }
