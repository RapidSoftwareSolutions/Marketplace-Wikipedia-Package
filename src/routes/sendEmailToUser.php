...
$app->post('/api/Wikipedia/sendEmailToUser', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['username','password','target','text']);
    ...
    $requiredParams = ['username'=>'username','password'=>'password','target'=>'target'];
    $optionalParams = ['subject'=>'subject','text'=>'text','copyToMe'=>'ccme'];
    $bodyParams = [
       'query' => ['target','token','subject','text','ccme']
    ];
    ...
    $requestParams['form_params']['action'] = 'emailuser';
