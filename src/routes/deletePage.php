...
$app->post('/api/Wikipedia/deletePage', function ($request, $response) {
    ...
    $optionalParams = ['reason'=>'reason','customParams'=>'customParams','tags'=>'tags','watchList'=>'watchlists'];
    $bodyParams = [
       'query' => ['pageid','token','reason','tags','watchlists']
    ];
    ...
    $requestParams['form_params']['action'] = 'delete';
